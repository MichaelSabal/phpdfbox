...
require_once('../pdfparser/PDFParser.php');
require_once('./XrefTrailerResolver/XRefType.php');
...
require_once('../io/MemoryUsageSetting.php');
require_once('../io/RandomAccessBuffer.php');
require_once('../io/RandomAccessBufferedFileInputStream.php');
require_once('../io/RandomAccessInputStream.php');
